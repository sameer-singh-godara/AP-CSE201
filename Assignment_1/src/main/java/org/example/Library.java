        ...
        for (Book book : totalBooks){
            if (book.getBookId() == bookId && title.equals(book.getTitle()) && book.getIssued() == 1 && (member.getName()).equals(book.getMember().getName())){
                ...
                if (timeAfterDueDate>10){
                    ...
                    System.out.println("Book Title: " + book.getTitle() + " with Id: " + book.getBookId() + " Has been Returned Successfully, Please pay the fine for late submission of Book");
                }
                else {
                    System.out.println("Book Title: " + book.getTitle() + " with Id: " + book.getBookId() + " Has been Returned Successfully");
                }
            }
        }
    }
